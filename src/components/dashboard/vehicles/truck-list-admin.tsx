...
import { updateTruck } from '@/app/dashboard/vehicles/actions'
...
export default function TruckListAdmin({ trucks }: { trucks: Truck[] }) {
    ...
    async function clientAction(formData: FormData) {
        ...
        const res = await updateTruck(editingTruck.id, formData)
        setIsSubmitting(false)
        if (res?.success) handleClose()
        else alert(res?.error || 'Error al actualizar el camión')
    }
